    ...
    <div className="bg-linear-to-b from-brand-light/30 to-white">
      <div className="max-w-6xl mx-auto px-4 py-20 text-center">
        ...
        <div className="mt-8 flex flex-col sm:flex-row justify-center gap-4">
          ...
          <Link to="/post-ride" className="bg-white border border-brand text-brand px-5 py-3 rounded hover:bg-blue-50">Post a Ride</Link>
          <Link to="/courier" className="bg-white border border-brand text-brand px-5 py-3 rounded hover:bg-blue-50">Courier</Link>
        </div>
      </div>
    </div>
  );
